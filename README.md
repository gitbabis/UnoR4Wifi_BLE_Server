...
> **Σημείωση:** Το `LED_BUILTIN` στο Arduino Uno R4 είναι συνδεδεμένο στο Pin 13. Επειδή το Pin 13 χρησιμοποιείται και για το ρολόι της οθόνης (SCK), το ενσωματωμένο LED ενδέχεται να αναβοσβήνει γρήγορα κατά την ενημέρωση της οθόνης.
